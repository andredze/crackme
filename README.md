...
### Проанализировав основную часть программы, я выяснил:
...
### Проанализируем теперь функцию verify_password
...
Заменив байты, отвечающие за команду "je 0126" на байты, отвечающие команде NOP NOP (не исполнять никакую операцию), я уберу эту проверку и программа независимо от ввода будет выводить "Access granted"
